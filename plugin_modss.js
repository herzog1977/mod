...
(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.2', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = false, leftVipD = '', user_id = '', uid = '382215acf83c6d1f321b958e5', IP = '2a02:3100:5b8e:91c5:9e3:12f7:5089:217', logged = false, VAST_url = false;
	  ...
	  rating_kp_imdb:function (card) {
        ...
        Pub.network.clear();
          ...
          var kp_rating = !isNaN(kp) && kp !== null ? parseFloat(kp).toFixed(1) : card.kp_rating || '0.0';
  			  ...
  			  user_id: user_id,
  			  uid: uid,
  			  ips: '2a02:3100:5b8e:91c5:9e3:12f7:5089:217',
          id: '',
          auth: logged
  			});
			});
...
// https://codeberg.org/cuschk/somafm
  ...
  function Radio_n(object) {
	...
	this.discovery = function () {
		...
		function gtag() {
			var idl = '2a02:3100:5b8e:91c5:9e3:12f7:5089:217';
